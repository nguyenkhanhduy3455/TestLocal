...
export interface DrugRxRow {
    ...
    dgNm: string
    /**
     * `mst_drug_rx.cnt1` — 使用量 mặc định của thành phần đầu. Dòng trn_trn có
     * `freewd` khác giá trị này thì ô dựng lại phải đổi theo freewd
