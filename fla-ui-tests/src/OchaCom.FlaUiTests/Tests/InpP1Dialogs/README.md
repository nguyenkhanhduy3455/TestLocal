...
```
../../../../web-tenant-tests/tests/dialogs-management/step-edit-dialog.spec.ts        (TC-STEP-*)
../../../../web-tenant-tests/tests/dialogs-management/inp-p1-ported-dialogs.spec.ts   (TC-CHK-* / TC-BR-*)
```
