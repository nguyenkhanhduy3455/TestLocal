...
| Viết / sửa test WinForm (FlaUI) | **`fla-ui-tests/FLA-UI-GUIDELINE.md` (F1–F25)** → `fla-ui-tests/README.md` → README của luồng trong `Tests/<luồng>/` |
...
## 6. Bảng tra luật (Rule 1–23 · web) và (F1–F25 · WinForm)
...
> Bên **WinForm** (`fla-ui-tests/`) có bộ luật riêng **F1–F25**, đánh số khác để không lẫn:
